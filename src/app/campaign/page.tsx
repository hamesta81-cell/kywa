...
export default function CampaignPage() {
  ...
  const missions = [
    ...
    },
    {
      ...
      title: "집중호우 지하차도 & 침수 탈출",
      desc: "수위 타이어 2/3 지점 최적 탈출 타이밍 판단.",
      category: "재난안전",
      time: "약 3분",
      timeCategory: "3분 이하",
      difficulty: "보통",
      ...
      lockReason: null,
      maintenanceInfo: null,
      img: "/images/cards/card_05_heavy_rain.jpg",
      href: "/campaign/disaster-evacuation",
      borderLeft: "border-l-4 border-l-[#2563EB]",
      tagColor: "bg-blue-50 text-[#2563EB]"
    },
    {
      id: "cpr-basics",
      title: "심폐소생술 4분의 기적 (CPR & AED)",
      desc: "가슴 압박 30회와 자동심장충격기 실전 적용.",
      category: "생활안전",
      time: "약 3분",
      timeCategory: "3분 이하",
      difficulty: "보통",
      ...
      lockReason: null,
      maintenanceInfo: null,
      img: "/images/life_zone_safety_hero.png",
      href: "/campaign/cpr-basics",
      borderLeft: "border-l-4 border-l-[#E11D48]",
      tagColor: "bg-rose-50 text-[#E11D48]"
    },
    {
      id: "fire-escape",
      title: "화재 대피 및 완강기 사용법",
      desc: "젖은 수건 낮은 자세 대피와 완강기 4단계 탈출.",
      category: "활동안전",
      time: "약 4분",
      timeCategory: "5분 이하",
      difficulty: "어려움",
      ...
      lockReason: null,
      maintenanceInfo: null,
      img: "/images/cards/card_01_heatwave.jpg",
      href: "/campaign/fire-escape",
      borderLeft: "border-l-4 border-l-[#EA580C]",
      tagColor: "bg-orange-50 text-[#EA580C]"
    }
  ];
